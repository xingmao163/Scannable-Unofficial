...
public final class DataGeneration {
    ...
    public static void onGatherData(final GatherDataEvent event) {
        ...
        generator.addProvider(event.includeClient(), new ModLanguageProvider(output, Scannable.MOD_ID, "en_us"));
        generator.addProvider(event.includeClient(), new ModChineseLanguageProvider(output, Scannable.MOD_ID, "zh_cn"));
    }
