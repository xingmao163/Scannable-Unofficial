...
public final class Scannable {
    ...
    public Scannable(IEventBus modEventBus, ModContainer modContainer) {
        ...
        modEventBus.addListener(GatherDataEvent.Server.class, DataGeneration::onGatherDataServer);
        modEventBus.addListener(GatherDataEvent.Client.class, DataGeneration::onGatherDataClient);
    }
