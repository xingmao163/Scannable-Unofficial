...
/**
 * Renders a fullscreen scan-reveal wave effect using the depth buffer for per-pixel world-position
 * reconstruction. Draws additively onto the main color target via a manual {@link RenderPass}.
 */
